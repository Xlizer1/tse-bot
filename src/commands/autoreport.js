    ...
    try {
      ...
      if (!interaction.member.permissions.has("Administrator")) {
        return interaction.reply({
          content:
            "You do not have permission to use this command. Only administrators can configure automatic reports.",
      ...
      if (subcommand === "enable") {
        ...
        await interaction.reply(
          `Automatic daily reports enabled! Reports will be posted in ${channel} at ${timeStr} UTC.`
        );
