    ...
    async execute(interaction) {
        try {
            ...
            await interaction.reply(
                `Added: ${interaction.user.username} ${action}d ${amount} SCU of ${resourceName} at ${location}\n` +
            ...
            console.error('Error in addresources command:', error);
            await interaction.reply({ 
                content: 'An error occurred while adding your resources.', 
                ephemeral: true 
            });
        }
    },
