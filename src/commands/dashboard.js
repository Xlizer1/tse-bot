...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("dashboard")
    .setDescription(
      "Creates an interactive resource tracking dashboard (admin only)"
    )
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const dashboardEmbed = new EmbedBuilder()
        ...
        .setDescription(
          `Comprehensive overview of our resource collection efforts`
        )
        .addFields(
          {
          ...
          },
          {
            ...
            value: Object.entries(actionBreakdown)
              .map(([action, data]) => {
